    ...
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4  relative transition-all">
      ...
      <div className="hidden sm:flex items-center gap-8">
        ...
        <div className="relative cursor-pointer">
          ...
          <button className="absolute -top-2 -right-3 text-xs text-white bg-orange-600 w-[18px] h-[18px] rounded-full">
            3
          </button>
        </div>
      ...
      <div
        className={`${
          open ? "flex" : "hidden"
        } absolute top-[60px] left-0 w-full bg-white shadow-md py-4 flex-col items-start gap-2 px-5 text-sm md:hidden z-[1000]`}
      >
